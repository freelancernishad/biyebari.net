                ...
                <div class="container">
                    ...
                    <div class="content" style="padding: 10px 0; text-align: center;">
                        <h1 style="font-size: 28px; font-weight: 800; color: #1a202c; margin: 0 0 10px 0;">
                            Great News, {{ $receiverName }}!
                        </h1>
                        <p style="font-size: 16px; line-height: 1.6; color: #555; max-width: 500px; margin: 0 auto 25px auto;">
                            You have a new connection! <strong>{{ $senderName }}</strong> has accepted your invitation.
                        </p>
                            ...
                            <div class="profile-card-content" style="padding: 25px;">
                                ...
                                <div style="border-top: 1px solid #e2e8f0; padding-top: 15px;">
                                    ...
                                    <div style="display: flex; align-items: center; margin-bottom: 10px; font-size: 15px; color: #4a5568;">
                                        ...
                                        <strong>Height:</strong> {{ $receiverHeight }}
                                    </div>
                                    <div style="display: flex; align-items: center; font-size: 15px; color: #4a5568;">
                                        ...
                                        <strong>Occupation:</strong> {{ $receiverOccupation }}
                                    </div>
                                </div>
                                <div style="margin-top: 20px; border-top: 1px solid #e2e8f0; padding-top: 20px;">
                                    ...
                                    <p style="margin: 10px 0 0 0;"><a href="{{ $receiverProfileUrl }}" class="profile-link">Read Full Profile →</a></p>
                                </div>
                            </div>
                        </div>

                        <div style="text-align: center; margin-top: 30px;">
                            <p style="margin: 0 0 15px 0; font-size: 16px; color: #555;">Ready to start a conversation?</p>
                            <a href="{{ $receiverProfileUrl }}" class="button">Say Hello to {{ $senderName }}</a>
                        </div>
                    </div>
